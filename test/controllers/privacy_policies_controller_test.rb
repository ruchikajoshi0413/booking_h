...
class PrivacyPoliciesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create privacy_policy" do
    assert_difference("PrivacyPolicy.count") do
      post privacy_policies_url, params: { privacy_policy: { content: @privacy_policy.content, title: @privacy_policy.title } }
    end
  ...
  test "should update privacy_policy" do
    patch privacy_policy_url(@privacy_policy), params: { privacy_policy: { content: @privacy_policy.content, title: @privacy_policy.title } }
